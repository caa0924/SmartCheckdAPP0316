...
public class DeviceManagerDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String message = equip_name.getString("equip_code");
                ...
                case update:
                    if (soapObject != null) {
                        ...
                        try {
                            ...
                            initEquip(listItems);
                            EquipmentInfoAdapter adapter = new EquipmentInfoAdapter(DeviceManagerDetailActivity.this, R.layout.equipment_info, equip_list);
